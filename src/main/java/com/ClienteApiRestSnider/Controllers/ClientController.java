...
public class ClientController {
	...
	public ResponseEntity update(@RequestBody ClientModel model,@PathVariable Long id) throws Throwable, Exception {
		if (id == null || id<=0){
			return new ResponseEntity<>(new Object(){public String message="invalid or null id";}, HttpStatus.BAD_REQUEST);
		}

		var updatedEntity = this.service.update(model, id);
		if (updatedEntity == null){
			return new ResponseEntity<>(new Object(){public String message="invalid or null entity";},HttpStatus.BAD_REQUEST);
		}
	...
	public ResponseEntity getByDocNumber(@PathVariable String docNumber) throws Exception {
		if (docNumber == null || docNumber.length()<=8 || docNumber.length()>=15){
			return new ResponseEntity<>(new Object(){public String message="invalid or null docNumber";}, HttpStatus.BAD_REQUEST);
		}
